// App shell: owns the small amount of genuinely global state (active tab, MoM/QoQ
// mode, holiday toggles, the two comparison periods, the open audit key), wires the
// data hooks, and routes to one tab component. All data logic lives in hooks/; all
// SOQL in lib/queries.js; all presentation in tabs/ and components/.
...
// sendPrompt was an artifact-injected global in the original build. Locally it is
// not available; wire a real implementation (e.g. via lib/salesforce callClaude)
// when the vacation-coverage workflow is rebuilt.
